...
import { footer, footerNav } from "@/content/v1";
  ...
  return (
    <footer className="border-t border-[var(--border-subtle)] bg-[var(--surface-deep)]">
      <div className="mx-auto grid w-full max-w-[1180px] gap-10 px-5 py-14 sm:px-6 md:grid-cols-[1.1fr_1fr_0.8fr] md:px-8">
        <div>
          <Link href="/v1" aria-label="Immunovus home">
            <Logo />
          </Link>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3">
            ...
            <li>
              <Link href="/v1/contact" className="text-[var(--text-secondary)] transition-colors hover:text-[var(--text-primary)]">
                Privacy
              </Link>
            </li>
            <li>
