export const nav = [
  { href: "/v1/approach", label: "Approach" },
  { href: "/v1/technology", label: "Technology" },
  { href: "/v1/applications", label: "Applications" },
  { href: "/v1/validation", label: "Validation" },
  { href: "/v1/company", label: "Company" },
] as const;
...
export const hero = {
  ...
  primaryCta: { href: "/v1/applications", label: "Find out more" },
  secondaryCta: { href: "/v1/contact", label: "Talk to us" },
};
...
export const finalCta = {
  ...
  secondaryCta: { href: "/v1/applications", label: "See who it's for" },
};

export const pageCta = {
  headline: "Explore what's possible with Immunovus.",
  cta: { href: "/v1/contact", label: "Talk to our team" },
};
